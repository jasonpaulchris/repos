...
namespace Sports.Models.Pages
{
    public class PagedList<T> : List<T>
    {
        ...
        private static IQueryable<T> Order(IQueryable<T> query, string propertyName, bool desc)
        {
            ...
            return typeof(Queryable).GetMethods().Single(method => method.Name == (desc ? "OrderByDescending" : "OrderBy") && method.IsGenericMethodDefinition && method.GetGenericArguments().Length == 2 && method.GetParameters().Length == 2)
